...
Route::resource('products.transactions', 'Product\ProductTransactionController', ['except' => ['create','show', 'edit']]);

Route::resource('products.buyers', 'Product\ProductBuyerController', ['except' => ['create','show', 'edit']]);
